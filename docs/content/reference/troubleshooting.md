...
Most of these come down to network reality or how simbad serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

simbad rate-limits like any public site. simbad already paces
...
Where a surface is gated, simbad reads a cookie or token you supply
...
`simbad`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what simbad actually did
